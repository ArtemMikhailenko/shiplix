...
> = {
  inciCore: {
    ...
    tag: "SaaS",
    stack: ["NestJS", "Fastify", "PostgreSQL", "Redis", "React", "Vite", "Astro"],
    image: "/projects/zapys24-web.webp",
    images: ["/projects/zapys24-web.webp"],
    duration: "14 weeks",
    slug: "zapys24",
  ...
  marketplace: {
    ...
    tag: "Marketplace",
    stack: ["React", "Vite", "NestJS", "PostgreSQL", "Redis", "OpenSearch", "Socket.io"],
    image: "/projects/enez-catalog.webp",
  ...
  orthoDent: {
    ...
    image: "/projects/orthostore.webp",
    images: ["/projects/orthostore.webp"],
    duration: "",
    slug: "orthostore",
  },
  rentaLviv: {
...
> = {
  ...
  marketplace: {
    ...
    project: "marketplace",
    stack: ["Next.js", "NestJS", "PostgreSQL", "Redis", "Socket.io", "OpenSearch"],
    color: "text-cyan",
  },
  crm: {
